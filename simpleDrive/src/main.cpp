...
smartdrive Drivetrain = smartdrive(LeftDriveSmart, RightDriveSmart, DrivetrainInertial, 319.19, 320, 40, mm, 0.2);

motor Arm1 = motor(PORT5, ratio36_1, false);
